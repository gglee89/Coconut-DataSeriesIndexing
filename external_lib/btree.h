...
// get key value of current node
int BTreeNode::getkey(BTreeNode *node) { return *keys; }

// get sequence of current leaf
std::string BTreeNode::getsequence(BTreeNode *node) { return *sequence; }

// get key value of current node
int BTree::getkey(BTreeNode *node) { return getkey(node); }

// get sequence of current leaf
std::string BTree::getsequence(BTreeNode *node) { return getsequence(node); }
}  // namespace tree_m